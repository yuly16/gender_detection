...
def ark2npy(output_dir,mfcc_dir,dataset_dir):
	...
	for mfcc_file in mfcc_list:
		if mfcc_file.split('_')[0] == 'raw' and mfcc_file.split('.')[-1] == 'ark':
			...
			for key,mat in kaldi_io.read_mat_ark(mfcc_path):
				...
				np.save(np_file,mat)
def main():
	lbe_dir = "/mnt/workspace2/yuly/Gender_chinese/lbe"
	wav_dir = "/mnt/workspace2/yuly/Gender_chinese/wav"
	output_dir = "/mnt/workspace2/yuly/Gender_chinese_processed"
	dataset_dir = "/mnt/workspace2/yuly/gender_data/test"
	...
	ark2npy(output_dir,mfcc_dir,dataset_dir)
